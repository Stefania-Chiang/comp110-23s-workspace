...
# 0.0 Establish a global variable named points to track “adventure points”.
points: int = 0

# 0.1 Establish a global variable named player to track the player’s name.
player: str = ""

# 1.0 Define a main function, that returns None, and follows the Python idiom for calling main at the end of the program.
