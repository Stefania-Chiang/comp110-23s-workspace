    ...
    while playing:
        ...
        if choice == 5:
            ...
            if choice != 1 and choice != 2 and choice != 3 and choice != 4 and choice != 5:
                choice = int(input(f"Sorry {player}, your choice is unavailable in the game. {SAD}\nPlease enter a number from 1 to 5: "))
            if choice == 1:
                explore_asia()
            if choice == 2:
                explore_europe()
...
def explore_asia() -> None:
    ...
    while playing:
        ...
        if choice != 1 and choice != 2:
            choice = int(input(f"Sorry {player}, your choice is unavailable in Asia. {SAD}\nPlease enter a number from 1 to 2: "))
        if choice == 1:
...
def explore_europe() -> None:
    ...
    while playing:
        ...
        if choice != 1 and choice != 2 and choice != 3 and choice != 4:
            choice = int(input(f"Sorry {player}, your choice is unavailable in Europe. {SAD}\nPlease enter a number from 1 to 4: "))
        if choice == 1:
...
def explore_africa() -> None:
    ...
    while playing:
        ...
        if choice != 1 and choice != 2 and choice != 3:
            choice = int(input(f"Sorry {player}, your choice is unavailable in Africa. {SAD}\nPlease enter a number from 1 to 3: "))
        if choice == 1:
